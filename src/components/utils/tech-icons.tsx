...
const icons = {
  ...
  "HTML": {
    name: "HTML",
    icon: <SiHtml5 color="#ff3f3f"/>
  },
  "CSS": {
    name: "CSS",
    icon: <SiCss3 color="#1f99f7"/>
  },
  "GraphQL": {
    name: "GraphQL",
    icon: <SiGraphql color="#ff2dd8"/>
  },
  "Nuxtjs": {
    name: "Nuxtjs",
    icon: (
      <svg viewBox="0 0 400 400" height="1em" width="1em">
