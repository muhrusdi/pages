      ...
      <li>
        <div className="flex">
          ...
          <div className="border-yellow-500 border-l-4 pl-4 py-4">
            <div>
              <span className="text-sm text-blue-600 pb-4 block sm:hidden">2012-2016</span>
              <h3 className="text-2xl font-bold">State Polytechnic of Ujung Pandang</h3>
              <p className="text-gray-500 leading-normal mt-3">Computer and Network Engineering</p>
            </div>
          </div>
        </div>
      </li>
      <li>
        <div className="flex">
          ...
          <div className="border-green-500 border-l-4 pl-4 py-4">
            <div>
              <span className="text-sm text-blue-600 pb-4 block sm:hidden">2009-2012</span>
      ...
      <li>
        <div className="flex">
          ...
          <div className="border-blue-500 border-l-4 pl-4 py-4">
            <div>
              <span className="text-sm text-blue-600 pb-4 block sm:hidden">2006-2009</span>
      ...
      <li>
        <div className="flex">
          ...
          <div className="border-pink-500 border-l-4 pl-4 py-4">
            <div>
              <span className="text-sm text-blue-600 pb-4 block sm:hidden">2001-2006</span>
