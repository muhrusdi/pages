    ...
    <div className="md:flex -mx-4 items-center">
      <div className="w-full md:w-1/2 px-4">
        <div>
          ...
          <p className="mt-4 sm:mt-8 text-lg text-gray-400 line-clamp-2">{data?.frontmatter.abstract}</p>
          <Link to={`/blog/${data?.fields.slug}`} className="mt-8 sm:mt-10 inline-block text-lg">
