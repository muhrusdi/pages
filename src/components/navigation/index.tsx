        ...
        <div className="container max-w-screen-lg">
          <div className="flex py-7 sm:py-6 justify-between items-center">
            <div className="relative z-50">
              <Link to="/">
                <svg style={{height: 44}} className="transition-all" viewBox="0 0 745 745" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <CenterMenus ref={menusRef}>
              <ul className={`sm:flex justify-center -mx-2 uppercase text-sm border border-gray-700 sm:border-none rounded-lg bg-black items-center ${toggle ? "" : "hidden"}`}>
                <li className="px-2">
                  <Link to="/blog"  className="flex items-center text-gray-200 hover:text-white transition-all">
                ...
                <li className="px-2">
                  <Link to="/work" className="flex items-center text-gray-200 hover:text-white transition-all">
                ...
                <li className="px-2">
                  <a href="#"  className="flex items-center text-gray-200 hover:text-white transition-all">
                ...
                <li className="px-2">
                  <Link to="/profile"  className="flex items-center text-gray-200 hover:text-white transition-all">
            ...
            <div className="relative block sm:hidden">
              <button onClick={handleClick} className="align-middle bg-blueGray-900 w-10 h-10 rounded-md focus:outline-none flex items-center justify-center">
                {/* <BsList/> */}
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect x="4" y="4" width="4" height="4" rx="1.2" fill="url(#paint0_linear-768704)"/>
                  <rect x="4" y="10" width="4" height="4" rx="1.2" fill="url(#paint1_linear-742839)"/>
                  <rect x="4" y="16" width="4" height="4" rx="1.2" fill="url(#paint2_linear-868777)"/>
                  <rect x="10" y="5" width="9" height="2" rx="1" fill="#DCDCDC"/>
                  <rect x="10" y="11" width="9" height="2" rx="1" fill="#DCDCDC"/>
                  <rect x="10" y="17" width="9" height="2" rx="1" fill="#DCDCDC"/>
                  <defs>
                  <linearGradient id="paint0_linear-768704" x1="3.5" y1="4" x2="8" y2="8.5" gradientUnits="userSpaceOnUse">
                  <stop stopColor="#34D399"/>
                  <stop offset="1" stopColor="#059669"/>
                  </linearGradient>
                  <linearGradient id="paint1_linear-742839" x1="3.5" y1="10" x2="8" y2="14.5" gradientUnits="userSpaceOnUse">
                  <stop stopColor="#FBBF24"/>
                  <stop offset="1" stopColor="#D97706"/>
                  </linearGradient>
                  <linearGradient id="paint2_linear-868777" x1="3.5" y1="16" x2="8" y2="20.5" gradientUnits="userSpaceOnUse">
