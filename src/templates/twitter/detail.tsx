    ...
    <div>
      <header className="flex justify-center text-center">
        <div className="max-w-sm">
          <img
            className="h-36 mx-auto w-36 rounded-full"
            src="https://images.unsplash.com/photo-1593643946890-b5b85ade6451?ixid=MnwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1378&q=80"
            alt=""
          />
