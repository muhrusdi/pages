...
export const projects: ProjectItemType[] = [
  ...
  {
    title: "Mahapatih",
    description: "Mahapatih is a As a lead-edges security technology company",
    stacks: ["Typescript", "React", "Gatsbyjs"],
  },
  {
    title: "Hakku",
    description:
      "Prioritizing employee rights and welfare by providing flexible access to salaries through the Hakku financial platform.",
    stacks: ["Typescript", "React", "Nextjs"],
  },
  {
    title: "Kas Cerdas",
